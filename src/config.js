...
module.exports = {
  ...
  seedShardMaxAreaDegSq: floatFromEnv("SEED_SHARD_MAX_AREA_DEG_SQ", 40),
  seedShardMaxDepth: intFromEnv("SEED_SHARD_MAX_DEPTH", 6),
  preQuerySplitAreaDegSq: floatFromEnv("PRE_QUERY_SPLIT_AREA_DEG_SQ", 10),
  immediateSplitDepth: intFromEnv("IMMEDIATE_SPLIT_DEPTH", 4),
